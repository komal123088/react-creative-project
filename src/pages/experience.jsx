...
const projects = [
  ...
  {
    img: img7,
    title: "Interaction Design Diploma",
      ...
      <div className="project-main">
                ...
                {projects.map((project, index) => (
                  <div key={index} className={`project-card ${"simple-card"}`}>
                    <div className="project-mockup">
                      ...
                      <span className="nda-badge">Full Time</span>
                    </div>
        ...
        <div className="projects-footer section">
          ...
          <div className="p-para">
            <span>
              “Working and learning design has always been fun and interesting”
            </span>
            Haha, I really meant it. Every journey brings me joy and priceless
            lessons. I’m grateful to meet all the people that i have met, and
            I’m so excited to meet more amazing people out there.
          </div>
        </div>
      </div>
    </>
